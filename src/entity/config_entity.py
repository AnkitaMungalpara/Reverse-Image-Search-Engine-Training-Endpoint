...
class DatabaseConfig:
    def __init__(self):
        ...
        self.URL: str = (
            "mongodb+srv://<username>:<password>@cluster0.kyn1evb.mongodb.net/?retryWrites=true&w=majority"
        )
...
class TrainerConfig:
    def __init__(self):
        self.MODEL_STORE_PATH = os.path.join(
            from_root(), "model", "finetuned", "model.pth"
        )
        self.EPOCHS = 3
...
class ImageFolderConfig:
    def __init__(self):
        ...
        self.IMAGE_SIZE = 256
        self.LABEL_MAP = {}
        self.BUCKET: str = "image-databse-system-01"
...
class AnnoyConfig:
    def __init__(self):
        self.EMBEDDING_STORE_PATH = os.path.join(
            from_root(), "data", "embeddings", "embeddings.ann"
        )
...
class s3Config:
    def __init__(self):
        ...
        self.BUCKET_NAME: str = "image-databse-system-01"
        self.KEY = "model"
        self.ZIP_NAME = "artifacts.tar.gz"
        self.ZIP_PATHS = [
            (
                os.path.join(from_root(), "data", "embeddings", "embeddings.json"),
                "embeddings.json",
            ),
            (
                os.path.join(from_root(), "data", "embeddings", "embeddings.ann"),
                "embeddings.ann",
            ),
